...
import './WatchEntry.css';

const WatchEntry: React.FC = () => {

   const watchEntryTabs = [
  ...
  const uploadBoxes = [
    { title: 'Watch Image 1', description: 'Add your Watch Image 1' },
    { title: 'Watch Image 2', description: 'Add your Watch Image 2' },
    { title: 'Watch Image 3', description: 'Add your Watch Image 3s' },
    { title: 'Watch Image 4', description: 'Add the Watch Image' },
  ...
  return (
    <IonPage className="watch-entry bg-gradient">

        {/* Header */}
        <TopHeader pageTitle="Watch Entry" />
          ...
          <div className={`step-content ${direction}`}>
            {currentStep === 0 && (
              ...
              <IonList className='entry-content'>
                ...
                <IonItem>
                  <IonLabel position="fixed">Watch Expenses</IonLabel>
                  <IonInput placeholder="-" />
                </IonItem>
        ...
        {/* Bottom Navigation */}
        <BottomNavigation tabs={watchEntryTabs} />
