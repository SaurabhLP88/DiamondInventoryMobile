...
import { arrowForwardCircleOutline, calendarOutline, filter, arrowBackOutline  } from "ionicons/icons"; 
...
const Dashboard: React.FC = () => {
  ...
  return (
    <IonPage className="bg-gradient">
      ...
      {/* Page Content */}
      <IonContent scrollY={true} className="no-scroll ion-padding bg-white text-black rounded-content" fullscreen>
        ...
        <IonCard className="inventory-box">
          ...
          {/*<IonGrid className="no-padding">
            <IonRow className="inventory-icons">
              <IonCol className="inventory-item">
                <div className="icon-box"><IonImg src="assets/images/diamond1.svg" alt="Diamonds" className="icon" /></div>
          ...
          <IonGrid className="no-padding">
            {selectedCategoryKey === null ? (
              <IonRow className="inventory-icons">
                {categories.map((cat) => (
                  <IonCol className="inventory-item" key={cat.key} onClick={() => setSelectedCategoryKey(cat.key)}>
                    <div className="icon-box"><IonImg src={cat.icon} alt={cat.label} className="icon" /></div>
              ...
              <>                
                <IonRow className="inventory-icons">
                  <IonCol className="centered-col" onClick={() => setSelectedCategoryKey(null)}>
                    <IonIcon icon={arrowBackOutline} /> {selectedCategory?.label}
                  </IonCol>
                  {selectedCategory?.subCategories.map((sub, i) => (
                    <IonCol className="inventory-item" key={i} onClick={() => history.push(sub.path)}>
                      <div className="icon-box"><IonImg src={sub.icon} alt={sub.label} className="icon" /></div>
